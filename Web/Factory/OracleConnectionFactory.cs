...
/// <summary>
/// Concrete factory implementation responsible for creating and opening fully managed Oracle database connections.
/// </summary>
public sealed class OracleConnectionFactory(string defaultConnectionString) : IDbConnectionFactory
{
